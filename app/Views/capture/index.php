    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h1>
                        Captura de Movimiento de <font color="blue"><b>Moldes</b></font>
                    </h1>
                </div>
                <div id="alert" >
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            ...
                            <input id="order_id" name="order_id" type="hidden" value="">
                                <h2 class="card-inside-title" id="molddept">Molde</h2>
                                <div class="form-line">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data == 1) {
                    ...
                    console.log("data 2");
                    document.getElementById("alert").innerHTML  = "Solicitud de departamento"; 
                    document.getElementById("alert").className = "alert alert-success"; 
                    document.getElementById("molddept").innerHTML  = "Departamento"; 
                    document.getElementById("mold_qr").readOnly = true;
                    document.getElementById("technician_qr").readOnly = false;
                    document.getElementById("type_work_qr").readOnly = true;
                    document.getElementById("priority_qr").readOnly = true;
